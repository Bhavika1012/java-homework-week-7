 ...
 */
public class Person {
    String firstName, lastName; //Declaring instance variable
    int age; // instance variable

    public void getFirstName() { //Declaring instance method
        System.out.println(firstName); //Returning first name
    }

    public void getLastname() { //instance method
        System.out.println(lastName); //Returning last name
    }
    ...
    public String getFullName() {//Declaring instance method with a return type
